...
<div align="center">
  ...
  <img src="https://www.ceupe.com/images/easyblog_articles/3461/productos-en-estantera.jpg" alt="logo" width="600"  height="auto" />
  <br/>
...
- Go to this repo and copy the project link
        https://github.com/sambeck87/product_crud
- Open your terminal and clone the repo with this command
```
git clone https://github.com/sambeck87/product_crud.git
```
...
- [ ] **User creation will be implemented**
- [ ] **The views will be styled**
...
I thank MANUABLE for considering my application for the position of junior developer.
